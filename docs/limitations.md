...
- 43 pattern do maintainer tổng hợp và chưa được hiệu chỉnh trên corpus đại diện.
- 103 example đã được coding agent audit về preservation nhưng chưa được maintainer hoặc reviewer độc lập xác nhận. Chúng cũng chưa đại diện đầy đủ cho vùng miền, thế hệ, ngành nghề hoặc register tiếng Việt.
...
- Benchmark có 33 case và chưa có independently-reviewed baseline từ nhiều reviewer bản ngữ. Chỉ sau review thật, điểm mới có giá trị cho so sánh trong phạm vi case đã lấy mẫu.
