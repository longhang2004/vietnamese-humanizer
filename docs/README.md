...
- [Architecture](architecture.md): package layout, data flow, and CLI boundaries.
- [Evaluation methodology](evaluation-methodology.md): corpus review and benchmark methodology.
- [Limitations](limitations.md): known technical and representational limits.
- [Research notes](research-notes.md): sources, comparisons, and attribution.

## Authoring and maintenance

- [Pattern authoring guide](pattern-authoring-guide.md): requirements for adding or changing patterns.
