...
3. Tìm pattern trùng theo ID, tên, summary, signals và tác động; không chỉ tìm phrase giống nhau.
4. Xác minh pattern trên ít nhất hai ngữ cảnh. Tìm phản ví dụ hợp lệ. Không merge heuristic thiếu bằng chứng.
